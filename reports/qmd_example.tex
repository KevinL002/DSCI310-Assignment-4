...
\includegraphics[width=3.125in,height=\textheight,keepaspectratio]{../results/horse_pops_plot.png}

}

\caption{\label{fig-horsepop}}
...
We can see from Figure~\ref{fig-horsepop} that Ontario, Saskatchewan and
...
\caption{\label{tbl-horses_sd}Horse Population}
...
span as Figure~\ref{fig-horsepop}.
...
In Figure~\ref{fig-horsepop-sd} we zoom in and look at the province of
