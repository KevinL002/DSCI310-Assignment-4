...
![](../results/horse_pops_plot.png){#fig-horsepop fig-cap="Horse population trends" width=300}
...
Additionally, note that in @tbl-horses_sd we consider the sample standard deviation of the number of horses during the same time span as @fig-horsepop.

![](../results/horse_pop_plot_largest_sd.png){#fig-horsepop-sd fig-cap="Horse population plot with largest standard deviation" width=70%}

Figure 2: Horse populations for the province with the largest standard deviation

In @fig-horsepop-sd we zoom in and look at the province of `r largest_sd`, which had the largest spread of values in terms of standard deviation.
